...
from cookbooks.finance_grader.stock_analysis.valuation_analysis import (
...
from cookbooks.finance_grader.stock_search.search_relevance import (
...
def load_reference_answers_from_file(
    ...
    try:
        ...
        raise ValueError(f"Error loading reference answers: {e}") from e
