...
set -e
#===============================================================================
# DeepFinance Training Script (AgentScope Tuner) - Single Node
...
SUFFIX="deepfinance_single"     # Experiment suffix, affects log and experiment name
PREFIX="agentscopetuner_sing"             # Experiment prefix, affects log folder
...
# Single-node GPU configuration
GPU_PER_NODE=8                        # Number of GPUs on this machine
...
MAX_MODEL_LEN=40960                   # Max model length (model's max supported value)
...
# Adaptively compute tensor_parallel_size and engine_num
...
RUNNER_PER_MODEL=8                    # Parallel runners per model
...
SEQ_PARALLEL_SIZE=${TRAINER_GPU}      # Sequence parallelism degree, must be ≤ TRAINER_GPU
...
if [ -n "${CONDA_PATH}" ] && [ -f "${CONDA_PATH}" ]; then
    ...
    echo -e "\033[31mPlease configure CONDA_PATH in the .env file\033[0m"
    exit 1
fi
...
#===============================================================================
# 3. Dynamically generate configuration file
#===============================================================================
...
# Single-node mode, NODE_NUM fixed to 1
NODE_NUM=1
...
#===============================================================================
# 4. Export environment variables (used by Judge and MCP)
#===============================================================================
# Judge configuration
...
#===============================================================================
# 6. Main workflow (single-node mode)
#===============================================================================
log "Single-node training mode: ${SUFFIX}"
log "GPU count: ${GPU_PER_NODE}"

# [Important] Set Ray runtime environment variables
