...
- Each paragraph must include sufficient in-line citations to the original document sources that support the information provided.
...
- [Detailed paragraph 1 with specific information and sufficient depth (>= 2000 chars)]. [Citation](reference_file.pdf)
- [Detailed paragraph 2 with specific information and sufficient depth (>= 2000 chars)]. [Citation](reference_document.pdf)
- ...
