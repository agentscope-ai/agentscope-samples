        ...
        {diffLines.map((item, index) => (
          <div
            ...
            style={{
              display: 'flex',
              backgroundColor:
                item.type === 'addition' ? 'rgba(40, 167, 69, 0.2)' :
                  item.type === 'deletion' ? 'rgba(203, 36, 49, 0.2)' :
                    item.type === 'info' ? 'rgba(88, 96, 105, 0.2)' :
                      'transparent',
              padding: '2px 10px',
              whiteSpace: 'pre',
            }}
          >
            <span style={{
              color:
                item.type === 'addition' ? '#28a745' :
                  item.type === 'deletion' ? '#cb2431' :
                    item.type === 'info' ? '#586069' :
                      '#abb2bf'
            }}>
              {item.line}
            </span>
