...
setup_command_name = config.get('SETUP_COMMAND_NAME', 'AgentScope-Bricks-starter')

# 生成带UUID的包名
base_name = config.get('SETUP_NAME', 'AgentScope-Bricks-starter')
...
setup(
    ...
    description=config.get('SETUP_DESCRIPTION', 'AgentScope-Bricks-starter'),
    long_description=config.get('SETUP_LONG_DESCRIPTION', 'AgentScope-Bricks-starter services, supporting both direct execution and uvicorn deployment'),
